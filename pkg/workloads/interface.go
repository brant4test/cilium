...
type WorkloadOwner interface {
	...
	// EndpointLabelsChanged is called whenever an endpoint has updated
	// identity or informational labels
	EndpointLabelsChanged(ep *endpoint.Endpoint, identityLabels, infoLabels labels.Labels) error
}
